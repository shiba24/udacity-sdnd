...
from keras.layers import Flatten, Dense, Dropout, Flatten, Lambda, Cropping2D
...
def training(X, y, modelname='model.h5', gpu=-1):
    ...
    model.fit(X, y, validation_split=0.2, shuffle=True, nb_epoch=4)
